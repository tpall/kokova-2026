...
md <- c(md, "",
  ...
  "",
  sprintf("Võistlustõlge: puuduv Hundipea algus lisab ~0,9 h (11 km neutraliseeritult + ~5 km oma tempoga), ehk **~8,1 h stardist kaini** — Rohukülas ~05:05, %s sihtajast ~70 min varem. Ka päevase sõidu optimismi maha arvates on 06:30 praam varuga käes.", format(GATE_FERRY - 0.25 * 3600, "%H:%M")),
  "",
