...
md <- c(
  ...
  sprintf("Sa jääd sellest maha **%s minutiga** — ja järgmine väljumine on pühapäeva 08:15, seega ootamist **%s tundi**.",
          ...
          num_et(sor_wait_h, 1)),
  "",
  sprintf("Lõpetad **%s** (%s h). 2025. aasta tempoga oleks see **%s** (%s h) — vahest ligi pool tuleb sellest ühest praamist, ülejäänu vormist.",
...
md <- c(md, "",
  ...
  "",
  sprintf("2025. aasta Kõkõval tegid vastupidist ja see töötas: läbi esimese öö (%.0f km), siis kokku ainult %s h und terve %.0f-tunnise võistluse peale.",
